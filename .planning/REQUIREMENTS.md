...
- [ ] **PAGE-01**: Visitor sees a nav with the app icon, wordmark, in-page links, and a GitHub button
- [ ] **PAGE-02**: Visitor sees a hero with the badge, H1, animated marker squiggle, subhead, and both CTAs, matching the prototype's rotations and hard-offset shadow
- [ ] **PAGE-03**: Visitor sees the taped-up polaroid hero screenshot with its handwritten labels and hand-drawn arrow
- [ ] **PAGE-04**: Visitor sees "Who it's for" with the four audience chips and alternating rotations
- [ ] **PAGE-05**: Visitor sees "What you can do" as a full-bleed dark band with four paper cards
- [ ] **PAGE-06**: Visitor sees "How it's different" in three columns — vs highlighters, vs Excalidraw, vs screenshots
- [ ] **PAGE-07**: Visitor sees the origin-story card with its yellow "the story" tab
- [ ] **PAGE-08**: Visitor sees the 6 FAQ questions and answers as real page text
